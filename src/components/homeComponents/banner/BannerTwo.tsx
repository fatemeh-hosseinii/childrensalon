...
const BannerTwo = () => {
    const BannerTwo = {
        BannerSecond: [
            {
                id: 1,
                image: "https://cdn.childrensalon.com/media/cms/cache/1302x403/d/e/desktop-new-arrivals-dac2k95vn34g40w0koo0sk8ws.webp",
            }
        ],
    };
    ...
    const BannerRes: BannerItem[] = [
        {
            id: 1,
            image: "https://cdn.childrensalon.com/media/cms/cache/750x800/m/o/mobile-new-arrivals-a5eusqjhxw8cwk0ws4cw8wwcs.webp"
        }
    ];
    ...
    return (
        <>
            <Container>
                <div className="md:flex hidden flex-row justify-center items-center mt-20">
                    {BannerTwo.BannerSecond.map((elem: BannerItem) => (
                ...
                <div className="flex md:hidden flex-row justify-center items-center mt-20">
